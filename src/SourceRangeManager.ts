...
export const resetEarningsSourceRange = () => {
  ...
  log(
    `Reset earnings source range to default: ${SOURCE_RANGE_CONFIG.EARNINGS.DEFAULT_RANGE}`
  )
}

export const resetFixedExpensesSourceRange = () => {
  updateFixedExpensesSourceRange(
    SOURCE_RANGE_CONFIG.FIXED_EXPENSES.DEFAULT_RANGE
  )
  log(
    `Reset fixed expenses source range to default: ${SOURCE_RANGE_CONFIG.FIXED_EXPENSES.DEFAULT_RANGE}`
  )
}

export const resetVariableExpensesSourceRange = () => {
  updateVariableExpensesSourceRange(
    SOURCE_RANGE_CONFIG.VARIABLE_EXPENSES.DEFAULT_RANGE
  )
  log(
    `Reset variable expenses source range to default: ${SOURCE_RANGE_CONFIG.VARIABLE_EXPENSES.DEFAULT_RANGE}`
  )
}
